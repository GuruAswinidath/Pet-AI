...
TRIAGE_KB: dict[str, dict] = {
    ...
    "fever": {
        "label": "Fever / feels warmer than usual",
        "typical_triage_level": "soon",
        "questions_to_ask": [
            "Have you actually measured a temperature, or does the cat just feel warm to the touch?",
            "Any other symptoms alongside it - not eating, lethargy, vomiting, diarrhoea, or hiding?",
            "How long has the cat felt warm?",
            "Any known injury, recent vaccination, or exposure to other sick cats?",
        ],
        "red_flags": [
            "very high fever",
            "high fever",
            ...
            "unresponsive and hot to the touch",
            "fever lasting more than 2 days",
            "fever with lethargy",
            "fever with not eating",
            "fever with difficulty breathing",
            "fever with vomiting",
        ],
        "yellow_flags": [
            "feels slightly warm but acting normal",
            "mild warmth for less than a day",
        ],
        "owner_guidance": "A cat's normal body temperature runs higher than a human's, so 'feels warm to the touch' isn't always a true fever - a thermometer reading is the only reliable way to confirm one, though most owners can't safely take a cat's temperature at home. A true fever paired with any other symptom (not eating, lethargy, vomiting) or lasting more than a day or two should be seen by a vet rather than watched, since fever in cats is frequently a sign of infection that needs treatment.",
    },
